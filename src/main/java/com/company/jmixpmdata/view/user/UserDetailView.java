...
public class UserDetailView extends StandardDetailView<User> {
    ...
    @Subscribe(id = "ciDc", target = Target.DATA_CONTAINER)
    public void onCiDcItemPropertyChange(final InstanceContainer.ItemPropertyChangeEvent<ContactInformation> event) {
